...
preprocess_config=
train_config=conf/train-st-asrpbl.yaml
decode_config=conf/decode-st-asrpbl.yaml
...
# [ADD] configuration
data=data
pre_decoding_recog_model=../asr1b/exp/test/results/model.val1.avg.best  # ASR checkpoint path
pre_decoding_dir=../asr1b/exp/test/pre_decoding                         # pre_decoding dir path, made in stage3: pre-decoding
